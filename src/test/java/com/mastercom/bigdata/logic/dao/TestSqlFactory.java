...
public class TestSqlFactory {
    ...
    public void testInsertSql(){
        String expectedSql = "INSERT INTO JOB" +
                "(ID,DATABASE_TYPE,URL,USERNAME,PASSWORD,JOB_NAME,ORDER_CONTENT,PLAN_FREQUENCY,DAILY_TIME,DAY,DECLARATION,STATUS,STATES,CREATE_TIME)" +
                " VALUES(#{id},#{databaseType},#{url},#{username},#{password},#{jobName},#{orderContent},#{planFrequency},#{dailyTime},#{day},#{declaration},#{status},#{states},#{createTime})";
    ...
    public void testQueryParameters(){
        ...
        Assert.assertTrue(values.contains("20190108"));
